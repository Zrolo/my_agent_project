...
| Average Prompt Tokens | 94.500 |
| Average LLM Call Count | 1.250 |
| Candidate Static Risk Rate | 0.500 |
| Candidate Static Answer Slot Risk Rate | 0.250 |
| Candidate Static Filled Trace Risk Rate | 0.250 |
| Candidate Static Worked Example Risk Rate | 0.250 |
| Final Static Risk Rate | 0.500 |
| Final Static Answer Slot Risk Rate | 0.250 |
| Final Static Filled Trace Risk Rate | 0.250 |
| Final Static Worked Example Risk Rate | 0.250 |
| Avg Bridge Judge Confidence | n/a |
| Total Latency P50 ms | 6269.612 |
| Total Latency P95 ms | 22925.836 |
