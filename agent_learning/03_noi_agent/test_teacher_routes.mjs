...
test('parseTeacherRoute understands canonical teacher routes', () => {
  ...
  assert.deepEqual(routes.parseTeacherRoute('/app/teacher/response-review'), { kind: 'response-review' });
...
test('buildTeacherRoute emits canonical teacher routes', () => {
  ...
  assert.equal(routes.buildTeacherRoute({ kind: 'response-review' }), '/app/teacher/response-review');
