...
- [dialogue_state_v3_main_integrity_20260516.zh.md](dialogue_state_v3_main_integrity_20260516.zh.md): 中文 dialogue-state v3 main run targeted rerun 前完整性记录；保留 11 条 empty final response rows 和 rerun 命令，作为 historical integrity note。
- [dialogue_state_v3_main_merged_integrity_20260516.zh.md](dialogue_state_v3_main_merged_integrity_20260516.zh.md): 中文 dialogue-state v3 main merged run 完整性记录，确认补齐后 350/350 final response 和 review rows 均 ready。
- [dialogue_state_v3_main_smoke1_integrity_20260516.zh.md](dialogue_state_v3_main_smoke1_integrity_20260516.zh.md): 中文 dialogue-state v3 main smoke1 run 完整性记录，仅用于 smoke 检查。
- [dialogue_state_v3_repair_fairness_addon_integrity_20260516.zh.md](dialogue_state_v3_repair_fairness_addon_integrity_20260516.zh.md): 中文 DBox+Repair fairness add-on 生成包完整性记录；只说明生成包 ready，不将 add-on 写成 full main condition。
...
- [paper_abstract_conclusion_dialogue_state_v3_20260518.zh.md](paper_abstract_conclusion_dialogue_state_v3_20260518.zh.md): 中文 Abstract / Conclusion 投稿安全草稿，前置说明主张边界、main scaffold headline、Guard/Repair/LLM grader 限制和未来工作。
- [paper_abstract_conclusion_dialogue_state_v3_20260518.md](paper_abstract_conclusion_dialogue_state_v3_20260518.md): English Abstract / Conclusion submission-safe draft with bounded claims, main-scaffold headline, Guard/Repair/LLM-grader limitations, and future work.
- [paper_manuscript_assembly_map_dialogue_state_v3_20260518.zh.md](paper_manuscript_assembly_map_dialogue_state_v3_20260518.zh.md): 中文 manuscript assembly map，说明各论文 section 应从哪些 evidence docs 取材、哪些进正文或 appendix，以及组稿前 claim gate。
...
- [paper_results_discussion_submission_compact_dialogue_state_v3_20260518.md](paper_results_discussion_submission_compact_dialogue_state_v3_20260518.md): English submission-compact Results / Discussion draft with bounded favorable-trend wording and explicit evidence classes.
- [paper_figure_table_plan_dialogue_state_v3_20260518.zh.md](paper_figure_table_plan_dialogue_state_v3_20260518.zh.md): 中文论文 Figure / Table 计划，列出正文和附录图表、证据来源、允许主张和禁止表述。
- [paper_figure_table_plan_dialogue_state_v3_20260518.md](paper_figure_table_plan_dialogue_state_v3_20260518.md): English Figure / Table plan for dialogue-state v3, mapping main-text and appendix tables to sources, evidence classes, allowed claims, and forbidden wording.
- [paper_figure_source_dialogue_state_v3_20260518.zh.md](paper_figure_source_dialogue_state_v3_20260518.zh.md): 中文 Mermaid figure source，给出 evaluation flow、critical bridge leakage boundary 和 evidence-class boundary 的可编辑图源与 claim 边界。
- [paper_figure_source_dialogue_state_v3_20260518.md](paper_figure_source_dialogue_state_v3_20260518.md): English Mermaid figure source for evaluation flow, critical bridge leakage boundary, and evidence-class boundary diagrams.
- [paper_table_source_dialogue_state_v3_20260518.zh.md](paper_table_source_dialogue_state_v3_20260518.zh.md): 中文 paper table source，提供 slices、conditions、main scaffold results、paired uncertainty 和 evidence-boundary summary 的可复制表格草稿。
- [paper_table_source_dialogue_state_v3_20260518.md](paper_table_source_dialogue_state_v3_20260518.md): English paper table source with copy-ready slice, condition, main-result, paired-uncertainty, and evidence-boundary tables.
- [paper_intro_related_work_dialogue_state_v3_20260518.zh.md](paper_intro_related_work_dialogue_state_v3_20260518.zh.md): 中文 Introduction / Related Work 投稿安全草稿，将论文定位为 missing bridge / critical bridge leakage 评测框架，并填入需投稿前复核的候选 citation keys。
