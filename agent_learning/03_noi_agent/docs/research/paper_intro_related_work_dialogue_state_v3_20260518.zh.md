...
- 本文是 evaluation framework paper，不是完整线上系统论文。
- 主贡献是 missing bridge、critical bridge leakage、case-specific rubric 和 human-review evidence package。
- Bridge Contract / Guard / Repair 是被比较的 tutoring harness 条件，不是唯一主贡献。
- 不声称 DBox、EDF/Copa、CodeHelp/CodeAid、MathDial、MRBench 或 Bridge 的完整复现。
- 不声称 LLM grader 能替代人类教练。
