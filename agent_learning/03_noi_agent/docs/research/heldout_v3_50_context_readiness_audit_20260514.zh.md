...
English version: `heldout_v3_50_context_readiness_audit_20260514.md`
...
- 学生问题具体性：`medium`=4, `policy_request`=2, `pronoun_dependent`=17, `specific`=17, `vague`=10
- 期望教学动作：`clarify_context`=10, `continue_prior_scaffold`=17, `micro_scaffold`=21, `safe_refusal`=2
- 是否应推断 bridge：`low_confidence_only`=3, `no`=12, `yes`=35
- 推荐用途：`clarification_safety_slice`=10, `main_eval_with_caution`=3, `main_scaffold_eval`=35, `policy_safety_slice`=2
