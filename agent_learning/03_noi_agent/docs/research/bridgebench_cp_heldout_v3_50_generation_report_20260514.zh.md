...
本报告记录 `docs/research/bridgebench_cp_heldout_v3_50_draft.jsonl` 的生成结果。该数据集是 draft，等待教练复核；学生问题为 synthetic-but-grounded，不来自旧线上 AI 回复。
...
- `docs/research/heldout_v3_50_source_and_case_review.zh.xlsx` 是题源/case 复核表，不是 AI 回复盲评表；它故意不包含待评分 AI 回复。
