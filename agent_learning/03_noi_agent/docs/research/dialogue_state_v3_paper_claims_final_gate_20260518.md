...
| Bridge Contract compact + Guard/Repair shows a stable trend advantage in overall quality and critical-leakage control. | Main scaffold table; paired W/T/L; paired CI; sensitivity tables. | Bridge Contract significantly and comprehensively outperforms every baseline. |
